...
class MutualcapButtonWizard(FootprintWizardBase.FootprintWizard):
    ...
    def smdRectPad(self,module,size,pos,name):
        ...
        layerset = pcbnew.LSET(pcbnew.F_Mask)
    ...
    def BuildThisFootprint(self):
        ...
        # top line
        self.module.Add(self.smdRectPad(self.module,pcbnew.wxSize(w-2*oBorderWidth-2*clearance, oew), pcbnew.wxPoint(0,(-h/2)+oew/2),str(1)))
